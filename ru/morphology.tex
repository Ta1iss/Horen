...
\subsection{Падежи} Падежные окончания языка На'ви меняются в зависимости от того, оканчивается ли слово на согласную, гласную или дифтонг.\footnote{The
...
\begin{center}
\begin{tabular}{lccc}
 & Гласная  & Согласная \& Псевдогласная & Дифтонг \\
\hline
Номинатив & --- & --- & --- \\
Эргативный & \N{-l} & \N{-ìl} & \N{-ìl} \\
Винительный & \N{-t}, \N{-ti} & \N{-it}, \N{-ti} & \N{-ti}, \N{-it}, \N{-ay-t}, \N{-ey-t} \\
Дательный & \N{-r}, \N{-ru} & \N{-ur}, \N{-'-ru} & \N{-ru}, \N{-ur}, \N{-aw-r}, \N{-ew-r} \\
Притяжательный & \N{-yä}, \N{-o-ä}, \N{-u-ä} & \N{-ä} & \N{-ä} \\
Тематический  & \N{-ri} & \N{-ìri} & \N{-ri}  \\
...
\subsubsection{} Заметьте, что слова оканчивающиеся на псевдогласные \N{ll}
и \N{rr} получают окончания согласных: \N{trr-ä}, \N{'ewll-it}.
\index{pseudovowel!declension}\label{morph:decl:pseudovowel}

\subsubsection{} После гласных \N{o} и \N{u} притяжательный падеж отмечается окончанием
\N{-ä}, но после других гласных ставится \N{-yä}.  Так, \N{tsulfätuä}
от \N{tsulfätu}, однако \N{Na'viyä} от \N{Na'vi} и \N{lì'fyayä}
от \N{lì'fya}.

\subsubsection{} Существительные на \N{-ia} в притяжательной падеже имеют форму \N{-iä}, как в
\N{soaiä} от \N{soaia}.
...
\subsubsection{} В дополнение к нескольким местоимениям
(\horenref{morph:pron:irreg-gen}), имеется несколько существительных с with
нехарактерной формой притяжательного: \N{Omatikayaä} (от \N{Omatikaya}).  Они помечены в словаре.
...
\subsubsection{} Из-за сходства в звучании между \N{y} и
\N{i}, окончание винительного падежа \N{-it} упращается, когда присоединяется к дифтонгу, оканчивающемуся на \N{y}, как в \N{keyeyt} \E{ошибки} вместо
*\N{keyeyit}.  А так же в следствие схожества звука \N{w} и
\N{u}, такоеже упрощение может произойти с окончанием дательного падежа \N{-ur}, как в
\N{'etnawr} \E{ плечу,} так же как \N{'etnawur}.
\NTeri{1/25/2013}{http://naviteri.org/2013/01/awvea-posti-zisita-amip-first-post-of-the-new-year/}

\subsubsection{} Существительное с гортанной смычкой в конце может принимать окончание дательного падежа в форме \N{-ru}, как в \Npawl{lì'fyaolo\uwave{'ru}}.  В других случаях после согласных присоединяют \N{-ur}.
...
\subsubsection{} Разница между длинными и короткими окончаниями винительного и дательного падежей, по-видимому заключена лишь в вопросах стиля и благозвучия.

\paragraph{Рифовый На'ви} \label{morph:reef-navi:pat} \index{Reef Na'vi!patientive}
В рифовом далекте предпочитается использование формы \N{-ti}, вместо \N{-it}
и \N{-t}. \Omaticon

\subsection{Чуждые существительные}\index{noun!declension!foreign}
При заиствовании людских слов происходит их фонологическая адаптация в языке На'ви, как в
as \N{Kerìsmìsì} \E{Рождество}.  Среди прочих изменений в конце слова добавляется \N{-ì} так как слова в На'ви не могут оканчиваться на \N{s}.
