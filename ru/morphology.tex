...
Поскольку некоторые падежные окончания содержат гласные, которые могут привести к образорванию недопустимых кластеров, то пследняя \N{-ì} в таких заимствованиях отбрасывается, например в притяжательной форме, \N{Kerìsmìsä}. Возьмём к прмиеру город Кёльн:
...
\noindent Учтите что для винительного и дательного падежа допустимы только окончания, которые начинаются с гласной ---\N{-it} и \N{-ur}.  Строение слова в На'ви не разрешает форму \N{*Kelnti}.
\NTeri{8/1/2022}{http://naviteri.org/2022/01/aawa-tipangkxotsyip-a-teri-horen-lifyaya-a-few-little-discussions-about-grammar/}

\subsection{Неопреде\-лен\-ный суф\-фикс -o} Когда су\-ще\-стви\-тель\-ное полу\-чает суф\-фикс неопре\-де\-лен\-нос\-ти \N{-o}, ``какой-то, некоторый,''  то падеж\-ные окончания ставят после \N{-o} как в \N{puk-o-t}.
