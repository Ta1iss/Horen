...
никогда не принимает сокращённую форму множественного числа и всегда пишется
\N{ayu}.\index{'u@\textbf{'u}!no short plural}}
Префиксы двойственного и тройственного числа указываются всегда.
\index{plural!short} \label{morph:short-plural}
\LanguageLog

\subsubsection{} Когда к слову, которое начинается с \N{e} или
\N{’e}, присоединяется префикс двойственного или тройственного числа, то получившаяся последовательность гласных \N{*ee} сокращается до одной \N{e}. Таким образом \N{me+} $+$ \N{’eveng}
