...
\subsubsection{} Если у слога отсутствует начальная согласная, то инфикс по прежнему предшествует гласной. Как в \N{omum} $>$ \N{‹iv›omum} и \N{ftia}
$>$ \N{fti‹ats›a}.

\subsubsection{} Ударение остается на той гласной, которая имела его до вставки каких-либо инфиксов \N{\ACC{haw}nu} $>$
\N{h‹il\ACC{v›aw}nu}.\footnote{Исключение: глагол \N{o\ACC{mum}}
смещает ударение на \N{o} во всех склоняемых и производных формах
\N{i\ACC{vo}mum}, \N{nìaw\ACC{no}num}. \index{omum@\textbf{omum}!accenting}
Глагол \N{i\ACC{nan}} так же следует этому образцу \N{o\ACC{li}nan}.
\index{inan@\textbf{inan}!accenting}
}

\subsubsection{} Как правило инфиксы получает только одна часть составного слова.  Например, \N{yom-tìng} \E{кормить} это сочетание
\N{yom} \E{есть} и \N{tìng} \E{давать}.  Его совершенный вид это не
*\N{y\INF{ol}omtìng}, а \N{yomt\INF{ol}ìng}.  У большиства составных слов глагольная часть, которая получает инфиксы, находится в конце.  Впрочем, некоторые из них имеют её в начале. Такие составные слова в лексиконе просто нужно запомнить.  \index{verb!compound!infix location}

\subsubsection{} Небольшое число составных слов типа глагол+глагол получает инфиксы в обе части. Как в \N{kan'ìn} \E{интересоваться, специализироваться},
состоящем из \N{kan} \E{намереваться, целиться, направлять (оружие или что-либо) на цель} и \N{'ìn} \E{иметь занятие}.
...
В обычной беседе возвратный \N{si}-глагол совершенного вида \N{säpo\ACC{li}} часто произносят как
...
Принудительно-возвратный инфикс ``заставить (объект глагола) совершить глагольное действие на себя'' образуется от \N{\INF{äp}\INF{eyk}}, значит \N{po täpeykerkup} \E{он заставляет себя умереть}.  Переходностью исходного выражения определяется
использование падежей с глаголами, в которых находится \N{\INF{äp}\INF{eyk}}.
Смотрите \horenref{reflexive-of-causative} использование.
