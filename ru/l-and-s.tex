...
\subsection{Эпентеза инфиксов отношения} Если после инфикса положительного отношения \N{\INF{ei}} сразу следует гласная \N{i}, \N{ì} либо псевдогласная, то между ними добавляют 
...
\subsection{Сингармонизм} Это морфолого-фонетическое явление, состоящее в уподоблении гласных в рамках одного слова по одному или нескольким фонетическим признакам, таким как ряд, подъём (открытость) или огубленность.
...
\subsubsection{} Сослагательный инфикс будущего, \N{\INF{iyev}}, чаще всего предстает как \N{\INF{ìyev}}, с поддержкой первой гласной.
