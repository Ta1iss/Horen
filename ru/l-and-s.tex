...
\subsection{Имена собственные} Получая лексические префиксы
(\horenref{lingop:affixes}), имена собственные сохраняют изначальные заглавные буквы, как в \N{lì'fya le\uwave{Na'vi}}.

\subsection{Цитирование} Прямые цитаты в На'ви не выделяются ковычками.  Вместо этого используются цитатные частицы
...
есть еще несколько грамматических процессов которые на письме больше отражает грамматику, чем произношение.
...
\N{ay+} остается неизменным, \N{ayyerik}.
\LNWiki{18/4/2010}{https://wiki.learnnavi.org/index.php/Canon/2010/March-June\%23ay.2Byerik}

\subsection{Деление дефисами определительных фраз} В определенных коротких фразах, выражающих признак предмета, элементы таких речевых оборотов записываются через дефис.
