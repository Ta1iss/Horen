...
\noindent Смягчение не указывается во второй линии подстрочных описаний, где находится морфологическая разбивка на категории. (Как в примере
ex.\ref{lenition:ex01} ниже). 

\subsection{Гортанная смычка} Гортанная смычка не смягчается, если за ней стоит псевдогласная (\N{mì 'Rrta}, а не *\N{mì Rrta}).
...
\subsection{Предлоги} Некоторые предлоги вызывают смягчение если стоят перед словом: \N{fpi}, \N{ìlä}, \N{mì}, \N{nuä}, \N{ro}, \N{sko},
\N{sre} (и образованные от него \N{lisre} с \N{pxisre}), \N{wä}. Но если использовать их как суффикс, то тогда у слова к которому они присоединены смягчения не происходит. И у следующего далее.
...
Хотя взрывные согласные в начале слов на рифовом диалекте показываются как звонкие фрикативы, но на них также распространяется правило смягчения как в Лесном На'ви. Так что, даже если \N{txon} \E{ночь} произносится как на Рифовом На'ви как \N{don}, то смягченная форма все равно будет \N{ton}.
\LNWiki{8/1/2023}{http://naviteri.org/2023/01/reef-navi-part-1-phonetics-and-phonology/}

\section{Морфофонология}

\subsection{Слияние гласных} Так как одинаковые гласные не могут стоять друг за другом, то некоторые грамматические процессы влекут сокращение сдвоенной гласной до одиночной.\index{vowel!contraction}\label{l-and-s:contract}

\subsubsection{} Соединительная частица \N{-a-}, которой отмечают прилагательные, исчезает если присоединяется к \N{a}, находящейся в начале или конце слова, как в
