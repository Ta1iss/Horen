...
ult$\not$e Eywa ngahu}. Элизию не отображают письменно.\index{elision}
...
(\horenref{lingop:affixes})имена собственные сохраняют заглавные буквы, как в \N{lì'fya le\uwave{Na'vi}}.
...
\N{ay+} оставляют как есть, \N{ayyerik}.
...
пишется через дефис, \N{fìsyulang aean-na-ta'leng} \E{этот голубой-как-кожа
