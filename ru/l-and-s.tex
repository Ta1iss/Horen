...
\N{sre} (and derived \N{lisre} and \N{pxisre}), \N{wä}. Но как суффиксы они его не вызывают. Как у слова к которому они присоединены, так и следующего далее.
...
\subsection{Вопросительная частица} Когда использована как префикс \N{pe+}, то вызывает смягчение (\horenref{morph:pre:pe}). Например, \N{pehem} \E{какое (действие)?} Образовано от \N{kem} \E{действие, деятельность}.
